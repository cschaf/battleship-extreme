...
public abstract class Player implements Serializable {
     ...
     * @param xPos the first x-coordinate of the field to place the ship on.
     * @param yPos the first y-coordinate of the field to place the ship on.
     ...
     * placed.
     * @throws ShipAlreadyPlacedException if the ship has already been placed.
     * @throws FieldOutOfBoardException if the players' board does not contain the field.
     * @throws ShipOutOfBoardException if the ships boundaries exceed the board.
     */
